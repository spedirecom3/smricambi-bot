...
echo "=== Distribuzione SMR OS - Griglia Enterprise ed Evitamento XSS ==="
...
<head>
  ...
  <style>
    ...
    @media (max-width: 1199px) { .right-panel-hide { display: none !important; } }
    @media (max-width: 767px) { .mobile-hide { display: none !important; } }
  </style>
</head>
<body class="h-screen w-screen grid grid-cols-[72px_350px_1fr_300px] xl:grid-cols-[72px_350px_1fr_300px] lg:grid-cols-[72px_320px_1fr] md:grid-cols-[72px_300px_1fr] sm:grid-cols-[1fr] overflow-hidden bg-[#09090b]">

  <aside class="h-full bg-[#121214] flex flex-col items-center py-6 gap-6 border-r border-[#222226] shrink-0 mobile-hide">
  ...
  <aside id="chatListContainer" class="h-full bg-[#121214] border-r border-[#222226] flex flex-col overflow-hidden shrink-0">
  ...
  <main id="chatAreaContainer" class="h-full flex flex-col relative bg-[#09090b] border-r border-[#222226] overflow-hidden min-w-0">
  ...
  <aside id="profileCard" class="h-full bg-[#121214] flex flex-col right-panel-hide shrink-0 p-5 overflow-y-auto hidden">
